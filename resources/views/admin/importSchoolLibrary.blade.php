...
<section class="content-header">
    <h1>
        Import School Library&nbsp;&nbsp;
        <small><a href="{{asset('uploads/sample/college-library-sample.csv')}}" style="color:black;font-weight: bold;">(View Sample File)</a></small> 
    </h1>
</section>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                     <h3 class="box-title">Import School Library</h3>
                </div><!-- /.box-header -->
                @if (count($errors) > 0)
                ...
                <form id="add_school_library" class="form-horizontal" method="post" action="{{ url('/admin/saveSchoolLibrary') }}" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" id="schoolLibrary" name="schoolLibrary">
                            </div>
                        </div>                       
                    </div>
