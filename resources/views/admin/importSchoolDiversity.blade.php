    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <form id="add_school_diversity_detail" class="form-horizontal" method="post" action="{{ url('/admin/saveSchoolDiversity') }}" enctype="multipart/form-data">
...
<script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      $("#add_school_diversity_detail").validate({
          rules: fileRules,
          messages: {
              schoolDiversity: {
