...
class SchoolNetPriceInStateDetail extends Model {

    protected $table = 'college_net_price_instate';
    protected $fillable = [
        'id',
        'UnitID',
        'ANP_awarded_grant_or_scholarship_aid_2014_15',
        'ANP_awarded_grant_or_scholarship_aid_2013_14',
        'ANP_awarded_grant_or_scholarship_aid_2012_13',
